...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Utilisateur.photo'
        db.alter_column(u'hooter_app_utilisateur', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Utilisateur.photo'
        db.alter_column(u'hooter_app_utilisateur', 'photo', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
