...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Utilisateur', fields ['pseudo']
        db.create_unique(u'hooter_app_utilisateur', ['pseudo'])


    def backwards(self, orm):
        # Removing unique constraint on 'Utilisateur', fields ['pseudo']
        db.delete_unique(u'hooter_app_utilisateur', ['pseudo'])
