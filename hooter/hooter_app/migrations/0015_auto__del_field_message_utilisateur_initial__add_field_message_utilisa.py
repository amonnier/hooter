...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.utilisateur_createur'
        db.add_column(u'hooter_app_message', 'utilisateur_createur',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='utilisateur_createur+', null=True, to=orm['hooter_app.Utilisateur']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'hooter_app_message', 'utilisateur_initial',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='utilisateur_initial+', null=True, to=orm['hooter_app.Utilisateur']),
                      keep_default=False)

        # Deleting field 'Message.utilisateur_createur'
        db.delete_column(u'hooter_app_message', 'utilisateur_createur_id')
    ...
    models = {
        ...
        u'hooter_app.message': {
            ...
            'utilisateur_createur': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'utilisateur_createur+'", 'null': 'True', 'to': u"orm['hooter_app.Utilisateur']"})
        },
