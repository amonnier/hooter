...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.utilisateurinitial'
        db.add_column(u'hooter_app_message', 'utilisateurinitial',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='utilisateurinitial+', null=True, to=orm['hooter_app.Utilisateur']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'hooter_app_message', 'utilisateur_initial',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='utilisateur_initial+', null=True, to=orm['hooter_app.Utilisateur'], blank=True),
                      keep_default=False)

        # Deleting field 'Message.utilisateurinitial'
        db.delete_column(u'hooter_app_message', 'utilisateurinitial_id')
    ...
    models = {
        ...
        u'hooter_app.message': {
            ...
            'utilisateurinitial': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'utilisateurinitial+'", 'null': 'True', 'to': u"orm['hooter_app.Utilisateur']"})
        },
