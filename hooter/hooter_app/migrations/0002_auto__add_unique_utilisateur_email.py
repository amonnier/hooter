...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Utilisateur', fields ['email']
        db.create_unique(u'hooter_app_utilisateur', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Utilisateur', fields ['email']
        db.delete_unique(u'hooter_app_utilisateur', ['email'])
